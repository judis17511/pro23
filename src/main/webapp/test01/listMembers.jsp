...
<form method="post" action="${contextPath}/member.do">
	...
	<select name="action">
		...
		<option value="searchMember">아이디</option>
		<option value="searchPwd">비밀번호</option>
	</select>
...
<table border="1"  align="center"  width="80%">
 ...
 <c:forEach var="member" items="${membersList}" >     
   <tr align="center">
      ...
      <td><a href="${contextPath}/member.do?action=deleteMember&id=${member.id}">
      삭제하기</a>
      </td>
      <td><a href="${contextPath}/member.do?action=modMember&id=${member.id}">
      수정하기</a>
      </td>
